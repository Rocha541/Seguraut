    ...
    >
      <div className="page-wrap grid w-full gap-10 py-14 md:py-18 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:py-20">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-[#243a2d]/78 md:text-lg">
            ...
            return (
              <div key={item.title}>
                ...
                <article className="grid grid-cols-[3rem_minmax(0,1fr)] gap-4 p-5 md:grid-cols-[3.5rem_minmax(0,1fr)] md:p-6">
                  <div className="flex h-12 w-12 self-center items-center justify-center rounded-sm border border-[#51c057]/35 bg-[#edf8e9] text-[#102719]">
